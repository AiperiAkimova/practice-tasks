...
import './App.css';
import Blocks from './components/component/Blocks'
...
},
{
  ...
  profilePic:"https://cdn.discordapp.com/avatars/597170794111434753/bdcd695d491a681005f91113ec2459ae",
},
{
  id: "#0023",
  username: "Atzu",
...
},
{
  ...
  profilePic:"https://cdn.discordapp.com/avatars/218972931701735424/8252199d8e59762c4952597118e743b2",
},
];
...
<hr></hr>
     {blocks.map(element=>{
       return  <Blocks key={element.id} block={element.block} text={element.text}/>
})}
